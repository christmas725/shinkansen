# Tokyo Station Shinkansen Departure Board v0.4.2
...
- 정차역 슬라이드 속도를 현재 표시 중인 자막 가운데 가장 느린 속도에 통일
- 짧은 자막의 기존 7초 이동 속도를 기준으로 긴 자막은 이동 거리에 비례해 재생시간 자동 증가
- 모든 자막이 언어별 2회를 끝까지 재생한 뒤 다음 언어/자유석 안내로 전환
